...
```mermaid
flowchart TD
    A[Tema + arquivo fonte] --> B[Prompt estruturado]
    B --> C[ChatGPT Image 2]
    C --> D{Resultado}
    D -->|bom| E[Infográfico final]
    D -->|ajustes| B
    E --> F[Ebook / Instagram / Post]
```
